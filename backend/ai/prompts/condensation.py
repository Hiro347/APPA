...
- Meskipun informasi hanya menjawab sebagian dari query (menyebutkan nama brand tanpa mencantumkan harga secara spesifik), kamu TETAP HARUS mengekstraknya! Jangan mengabaikan data parsial yang berguna.
...
- Jika artikel sama sekali tidak memuat informasi yang berkaitan dengan topik, cukup output persis kalimat ini: "Tidak ada data spesifik yang relevan ditemukan."
